...
export default async function ListingDetailPage({
  ...
  return (
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-5">
              ...
              <div className="hidden lg:block bg-white rounded-xl border border-gray-200 p-6">
                ...
                <div className="mt-3">
                  <span className="text-3xl font-bold text-blue-600">{fmtPrice(listing.price, locale)}</span>
                  <span className="text-lg text-blue-400 ml-1">{t("sum")}</span>
                </div>
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-6">
                ...
                <div className="flex gap-2">
                  ...
                  >
                    ...
                    {locale === "ru" ? "Позвонить" : "Qo'ng'iroq"}
                  </a>
                  <a
                    href={`https://wa.me/${listing.sellerPhone.replace(/\D/g, "")}?text=${encodeURIComponent(locale === "ru" ? `Здравствуйте, я по объявлению: ${listing.title}` : `Salom, e'lon bo'yicha: ${listing.title}`)}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 flex items-center justify-center gap-2 bg-[#25D366] text-white py-3 rounded-xl font-semibold hover:bg-[#20BD5A] transition-colors"
                  >
                ...
                <div className="mt-2 text-center text-xs text-gray-400">{listing.sellerPhone}</div>
      ...
      <Footer />
      <MobileContactBar phone={listing.sellerPhone} title={listing.title} locale={locale} />
    </>
  );
}
